...
def wishMe():
    ...
    speak("Hi i am your assistant. How may i help you sir?? ")
...
def sendEmail(to, content):
    ...
    server.ehlo()
    server.starttls()
    server.login('arymishra212001@gmail.com', 'f')
    server.login()
    server.sendmail("parasingh016jan@gmail.com", to, content)
    server.close()
